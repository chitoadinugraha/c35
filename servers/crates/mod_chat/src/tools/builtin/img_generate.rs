...
tool! {
    ...
    description: "Generate, create, draw, paint, or render a new image, artwork, illustration, logo, icon, sketch, or photo from a text prompt. For editing an attached image, use img.edit instead. Draft default follows image.default_tier (lite or flash 1K); @image-high or quality hd uses Flash Image 2K.",
    topics: ["image"],
