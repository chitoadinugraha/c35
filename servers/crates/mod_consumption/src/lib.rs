...
pub use day::{day_bounds_ms, infer_meal_type, local_hour, multi_day_bounds_ms, resolve_day_id, today_day_id, timezone_from_locale};
...
pub use store::{
    ...
    nutrition_sum_day, prefs_calorie_goal,
};
