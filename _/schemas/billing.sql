...
INSERT INTO ai.billing_plan (
    ...
    ('lite', 'Lite', 'user', 10, 3.50, 1, 0.05, 1.00, 0, 1, 0,
     '{"outbound_gap_ms":10000,"outbound_gap_slow_ms":15000,"slow_model":"alienai","priority_queue":false,"prompt_followup_queue_max":0,"prompt_followup_steer_max":3}',
     FALSE, TRUE, 100000, 20000, 1, 'lite'),
    ('plus', 'Plus', 'user', 20, 7.00, 1, 0.25, 5.00, 0, 1, 0,
     '{"outbound_gap_ms":10000,"outbound_gap_slow_ms":15000,"slow_model":"alienai","priority_queue":false,"prompt_followup_queue_max":5,"prompt_followup_steer_max":20}',
     TRUE, TRUE, 175000, 35000, 4, 'plus'),
    ('pro', 'Pro', 'user', 30, 20.00, 1, 1.00, 20.00, 0, 1, 0,
     '{"outbound_gap_ms":10000,"outbound_gap_slow_ms":15000,"slow_model":"alienai","priority_queue":false,"queue_priority_multiplier":5,"prompt_followup_queue_max":5,"prompt_followup_steer_max":20}',
     TRUE, TRUE, 565000, 115000, 10, 'pro'),
    ('ultra', 'Ultra', 'user', 40, 65.00, 1, 4.00, 80.00, 0, 5, 0,
     '{"outbound_gap_ms":8000,"outbound_gap_slow_ms":15000,"slow_model":"alienai","priority_queue":true,"queue_priority_multiplier":30,"prompt_followup_queue_max":5,"prompt_followup_steer_max":20}',
